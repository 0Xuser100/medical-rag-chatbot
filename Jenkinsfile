        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token-medical-rag', url: 'https://github.com/0Xuser100/medical-rag-chatbot.git']])
                }
            }
        }
